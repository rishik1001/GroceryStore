...
try {
   ...
   rs2 = stmt.executeQuery("select * from items where category = 'Diary Products' and stock > 0");
} 
   catch (Exception e){
...
<div id = "blur">
        ...
        <div class = "type">
            <div class = "type-image">
                <p style = "color:white">Diary Products</p>
            </div>
        </div>
        <div class = "list">
            <% while(rs2.next()){%>
             ...
             {%>
                ...
                <div class="items" style="margin-left:250px;">
                    ...
                    <div class = "item-desc">
                        ...
                        <form method = "post" action = "diary.jsp">
                            <label>Qty</label>
